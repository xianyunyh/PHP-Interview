...
PRIMARY KEY（主键索引） ALTER TABLE \`table\_name\` ADD PRIMARY KEY \( \`column\` \)

UNIQUE\(唯一索引\) ALTER TABLE \`table\_name\` ADD UNIQUE \(\`column\`\)

INDEX\(普通索引\) ALTER TABLE \`table\_name\` ADD INDEX index\_name \( \`column\` \)

FULLTEXT\(全文索引\) ALTER TABLE \`table\_name\` ADD FULLTEXT \( \`column\` \)
